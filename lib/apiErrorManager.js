...
var ApiErrorManager = function(){
	...
	*/
	this.responseBadRequest = function(res, headers){
	...
	* @ return this for chaning
	*/
	this.responseUnauthorized = function(res, headers){
	...
	* @ return this for chaning
	*/
	this.responseForbidden = function(res, headers){
	...
	* @ return this for chaning
	*/
	this.responseNotFound = function(res, headers){
	...
	* @ return this for chaning
	*/
	this.responseInternalError = function(res, headers){
	...
	* @ return this for chaning
	*/
	this.responseNotImplemented = function(res, headers){
